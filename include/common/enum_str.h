...
template<typename T>
enum_const_ref_holder<T> enum2holder(T const &e) { return enum_const_ref_holder<T>(e); }

template<typename T>
enum_ref_holder<T> string2holder(const std::string &s) {
